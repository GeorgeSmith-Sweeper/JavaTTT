...
class TestBoard {
    ...
    void hasAPlayerOneReturnsTrueWhenAPlayerWinsByRow3x3() {
        ...
        assertEquals(true, testBoard.hasAPlayerWon(playerOne.getSymbol()));
    }
    ...
    void hasAPlayerOneReturnsFalseWhenAPlayerDoesntWin3x3() {
        ...
        assertEquals(false, testBoard.hasAPlayerWon(playerOne.getSymbol()));
    }
    ...
    void hasAPlayerOneReturnsTrueWhenAPlayerWinsByRow4x4() {
        ...
        assertEquals(true, board.hasAPlayerWon(playerOne.getSymbol()));
    }
